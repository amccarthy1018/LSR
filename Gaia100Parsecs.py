...
#Finding the LSR
Upeak = poptU[1]
Vpeak = -17.56834848 #See Maple worksheet for how this was determined
Wpeak = poptW[1]

LSR = np.array([Upeak, Vpeak, Wpeak])

sunMotion = np.array([-1*Upeak, -1*Vpeak, -1*Wpeak])

print("The LSR is", LSR)

print("The motion of the sun is", sunMotion)